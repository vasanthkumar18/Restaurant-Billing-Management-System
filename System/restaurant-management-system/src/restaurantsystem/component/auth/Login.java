...
public class Login extends javax.swing.JFrame {
    ...
    private void setDefaultUserName() {
        this.userNameField.setText("Vasanth");
        this.passwordField.setText("B180441CS");
    }
    ...
    private void initComponents() {
        ...
        loginPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "NIT Calicut Restaurant", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Lucida Grande", 0, 13), new java.awt.Color(0, 0, 204))); // NOI18N
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        if (userNameField.getText().equalsIgnoreCase("Vasanth") && passwordField.getText().equalsIgnoreCase("B180441CS")) {
